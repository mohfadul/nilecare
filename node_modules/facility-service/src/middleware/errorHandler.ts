...
/**
 * Custom Error Classes for Facility Service
 */
...
export class FacilityNotFoundError extends NotFoundError {
...
export class WardNotFoundError extends NotFoundError {
  constructor(wardId: string) {
    super(`Ward ${wardId} not found`);
  }
}

export class BedNotFoundError extends NotFoundError {
  constructor(bedId: string) {
    super(`Bed ${bedId} not found`);
  }
}

export class BedUnavailableError extends AppError {
  constructor(bedId: string, reason: string = 'Bed is not available') {
    super(`Bed ${bedId}: ${reason}`, 409);
  }
}
