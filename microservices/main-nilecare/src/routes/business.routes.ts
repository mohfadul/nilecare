...
const logger = winston.createLogger({
  ...
  transports: [
    ...
    new winston.transports.File({ filename: 'logs/business-proxy.log' })
  ],
 ...
 */
function handleProxyError(error: AxiosError | any, res: Response, targetPath: string) {
 ...
 */
router.get('/billing/:id', async (req: Request, res: Response) => {
 ...
 */
router.patch('/billing/:id/pay', async (req: Request, res: Response) => {
 ...
 * Cancel billing
 */
router.patch('/billing/:id/cancel', async (req: Request, res: Response) => {
 ...
 */
router.get('/billing/patient/:patientId', async (req: Request, res: Response) => {
 ...
 * Get schedule by ID
 */
router.get('/scheduling/:id', async (req: Request, res: Response) => {
 ...
 * Update schedule
 */
router.put('/scheduling/:id', async (req: Request, res: Response) => {
 ...
 * Cancel schedule
 */
router.delete('/scheduling/:id', async (req: Request, res: Response) => {
 ...
 * Get staff schedule
 */
router.get('/scheduling/staff/:staffId', async (req: Request, res: Response) => {
 ...
 */
router.get('/scheduling/slots', async (req: Request, res: Response) => {
 ...
 */
router.get('/staff/department/:department', async (req: Request, res: Response) => {
...
router.get('/summary', async (req: Request, res: Response) => {
  try {
    ...
    const [appointmentsRes, billingRes, staffRes, healthRes] = await Promise.allSettled([
      axios.get(`${BUSINESS_SERVICE_URL}/api/v1/appointments`, {
        params: { limit: 10 },
        headers: { Authorization: req.headers.authorization },
        timeout: 10000,
      }),
      axios.get(`${BUSINESS_SERVICE_URL}/api/v1/billing`, {
        params: { limit: 10 },
        headers: { Authorization: req.headers.authorization },
        timeout: 10000,
      }),
      axios.get(`${BUSINESS_SERVICE_URL}/api/v1/staff`, {
        params: { limit: 10 },
        headers: { Authorization: req.headers.authorization },
        timeout: 10000,
      }),
      axios.get(`${BUSINESS_SERVICE_URL}/health`, { timeout: 5000 }),
    ]);
