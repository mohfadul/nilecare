 ...
 */
router.get('/billing', authenticate, async (req: Request, res: Response) => {
  try {
    const data = await proxyToBusinessService(
      '/api/v1/billing',
      'GET',
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.get('/billing/:id', authenticate, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const data = await proxyToBusinessService(
      `/api/v1/billing/${id}`,
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.post('/staff', authenticate, async (req: Request, res: Response) => {
  try {
    const data = await proxyToBusinessService(
      '/api/v1/staff',
      'POST',
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.get('/staff/:id', authenticate, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const data = await proxyToBusinessService(
      `/api/v1/staff/${id}`,
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.get('/scheduling', authenticate, async (req: Request, res: Response) => {
  try {
    const data = await proxyToBusinessService(
      '/api/v1/scheduling',
      'GET',
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.post('/scheduling', authenticate, async (req: Request, res: Response) => {
  try {
    const data = await proxyToBusinessService(
      '/api/v1/scheduling',
      'POST',
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.post('/appointments', authenticate, async (req: Request, res: Response) => {
  try {
    const data = await proxyToBusinessService(
      '/api/v1/appointments',
      'POST',
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.patch('/appointments/:id/status', authenticate, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const data = await proxyToBusinessService(
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.patch('/appointments/:id/confirm', authenticate, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const data = await proxyToBusinessService(
 ...
 * ✅ ROUTED THROUGH BUSINESS SERVICE for audit logging
 */
router.patch('/appointments/:id/complete', authenticate, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const data = await proxyToBusinessService(
