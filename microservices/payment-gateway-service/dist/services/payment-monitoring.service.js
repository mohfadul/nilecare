...
class PaymentMonitoringService {
     ...
     * Check provider health
     */
    async checkProviderHealth(providers) {
     ...
     * Check processing times
     */
    async checkProcessingTimes(avgTime) {
     ...
     * Check pending verifications
     */
    async checkPendingVerifications(count) {
        if (count > 50) {
            await this.sendAlert({
                type: 'pending_verifications_high',
                severity: 'high',
     ...
     */
    async getTotalPayments(_startDate, _endDate) {
    ...
    async getFailedPayments(_startDate, _endDate) {
        // In production: Query from database
        // return await this.paymentRepository.count({
        //   where: {
        //     createdAt: Between(startDate, endDate),
    ...
    async getAverageProcessingTime(_startDate, _endDate) {
...
exports.default = PaymentMonitoringService;
//# sourceMappingURL=payment-monitoring.service.js.map