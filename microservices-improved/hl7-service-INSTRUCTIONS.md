# hl7-service Implementation Instructions

## File: microservices\hl7-service\src\index.ts

### Step 1: Backup created
✅ Backup at: microservices\hl7-service\src\index.ts.backup
...
app.get('/metrics', (req, res) => {
  ...
  res.send(`
hl7_service_uptime_seconds ${Math.floor((Date.now() - serviceStartTime) / 1000)}
...
(async () => {
  try {
    ...
    server.listen(3010, () => {
      console.log('✅ hl7-service started on port 3010');
      console.log('✅ Ready: http://localhost:3010/health/ready');
      console.log('✅ Metrics: http://localhost:3010/metrics');
    });
  } catch (error) {
