# business Implementation Instructions

## File: microservices\business\src\index.ts

### Step 1: Backup created
✅ Backup at: microservices\business\src\index.ts.backup
...
app.get('/metrics', (req, res) => {
  ...
  res.send(`
business_uptime_seconds ${Math.floor((Date.now() - serviceStartTime) / 1000)}
...
(async () => {
  try {
    ...
    server.listen(3002, () => {
      console.log('✅ business started on port 3002');
      console.log('✅ Ready: http://localhost:3002/health/ready');
