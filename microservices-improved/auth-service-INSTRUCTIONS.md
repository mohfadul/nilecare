...
✅ Backup at: microservices\auth-service\src\index.ts.backup
...
app.get('/metrics', (req, res) => {
  ...
  res.send(`
auth_service_uptime_seconds ${Math.floor((Date.now() - serviceStartTime) / 1000)}
...
(async () => {
  try {
    ...
    server.listen(3001, () => {
      ...
      console.log('✅ Ready: http://localhost:3001/health/ready');
