...
✅ Backup at: microservices\notification-service\src\index.ts.backup
...
app.get('/metrics', (req, res) => {
  ...
  res.send(`
notification_service_uptime_seconds ${Math.floor((Date.now() - serviceStartTime) / 1000)}
...
(async () => {
  try {
    ...
    server.listen(3014, () => {
      console.log('✅ notification-service started on port 3014');
      console.log('✅ Ready: http://localhost:3014/health/ready');
      console.log('✅ Metrics: http://localhost:3014/metrics');
    });
  } catch (error) {
